import 'package:dcourier/Home/home.dart';
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text("D'Courier", style: whiteTextStyle.copyWith(fontSize: 40, fontWeight: bold),),
              SizedBox(height:109),
              Column(
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        border: InputBorder.none,
                        contentPadding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                        suffixIcon:  IconButton(onPressed: () => passwordVisible, icon: Icon(Icons.visibility_off)) 
                      ),
